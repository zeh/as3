package com.zehfernando.net.apis.facebook.services {
	 ...
	 */
	public class FacebookPostsRequest extends BasicFacebookRequest {

		// By default, this gets the last 25 posts
		// TODO: join this with the FacebookFeedRequest service, but using something like .ownAuthor?
		...
		public function FacebookPostsRequest() {
			super();

			// Basic service configuration
			requestURL = FacebookConstants.SERVICE_DOMAIN + FacebookConstants.SERVICE_POSTS;
